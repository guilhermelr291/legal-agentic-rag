...
from services.extractors.base import ExtractionResult, TextExtractor
...
class DOCXExtractor(TextExtractor):
    ...
    def extract(self, file_path: str) -> ExtractionResult:
        ...
        try:
            ...
            for para_idx, para in enumerate(doc.paragraphs):
                ...
                if para.style and para.style.name:
                    ...
                    if "heading" in style_lower or "title" in style_lower:
                        ...
                        para_info["heading_level"] = self._extract_heading_level(
                            para.style.name
                        )
            ...
            return self._create_error_result(f"DOCX extraction failed: {str(e)}")
    ...
    def _build_page_boundaries(
        self, paragraphs: List[Dict[str, Any]], full_text: str, chars_per_page: int = 3000
    ) -> List[Dict[str, Any]]:
